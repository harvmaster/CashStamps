...
export class OraclesService {
  ...
  getOracleSymbol(oraclePublicKey: string | Uint8Array) {
    ...
    switch (oraclePublicKeyHex) {
      // USD
      case '02d09db08af1ff4e8453919cc866a4be427d7bfe18f2c05e5444c196fcf6fd2818':
        return '$';
      // EUR
      case '02bb9b3324df889a66a57bc890b3452b84a2a74ba753f8842b06bba03e0fa0dfc5':
        return '€';
      // AUD
      case '034e1d3be2ee29b3d9e53b354b09d9a5a2803c568d8c6520bc72d97494c9a100c2':
        return '$';
      // INR
      case '02e82ad82eb88fcdfd02fd5e2e0a67bc6ef4139bbcb63ce0b107a7604deb9f7ce1':
        return '₹';
      // CNY
      case '030654b9598186fe4bc9e1b0490c6b85b13991cdb9a7afa34af1bbeee22a35487a':
        return '¥';
    }
